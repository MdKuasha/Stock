Public Class EnterExams
    ...
    Private Sub bnenter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bnenter.Click
        If txtscore.Text = "" Then
            MsgBox("Exams Score cannot be empty!", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly)
            Exit Sub
        End If
        ...
        If Val(txtscore.Text) > 40 Then
            MsgBox("Exams Score cannot be above 60 marks!", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly)
            Exit Sub
        End If
        Dim db As New SMSDataContext
